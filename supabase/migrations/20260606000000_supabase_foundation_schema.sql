...
create table public.receipt_images (
  id uuid primary key default gen_random_uuid(),
  wood_receipt_id uuid not null references public.wood_receipts(id),
...
create table public.audit_logs (
  id uuid primary key default gen_random_uuid(),
  wood_receipt_id uuid references public.wood_receipts(id),
  actor_id uuid,
...
create index audit_logs_deleted_at_idx on public.audit_logs(deleted_at);
